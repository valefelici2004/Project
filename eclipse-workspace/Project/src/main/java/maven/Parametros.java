...
public class Parametros {
	...
	public static final int resolucionClave = 1 * 4 + 4 * 7; //1 byte por niveles de las 4 dimensiones, 4 bytes por los identificadores
	public static final int LonLatProfTemp =  64 * 64 * 10 * 10;
